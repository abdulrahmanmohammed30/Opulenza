...
namespace Opulenza.Infrastructure.Migrations
{
    ...
    [Migration("20250415111709_AddProductMetadata")]
    partial class AddProductMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Opulenza.Infrastructure.Categories.Persistence.CategoryRelationship", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Opulenza.Domain.Entities.Products.ProductMetadata", b =>
                {
                    b.HasOne("Opulenza.Domain.Entities.Products.Product", "Product")
                        .WithOne("ProductMetadata")
                        .HasForeignKey("Opulenza.Domain.Entities.Products.ProductMetadata", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Opulenza.Domain.Entities.Ratings.Rating", b =>
                {
                    ...
                    b.HasOne("Opulenza.Domain.Entities.Users.ApplicationUser", "User")
                        .WithMany("Ratings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
